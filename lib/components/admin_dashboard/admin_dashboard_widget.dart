                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 4.0, 12.0, 0.0),
                            child: Text(
                              'Manage Group Scehdule in this list',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    font: GoogleFonts.sora(
                  ...
                  children: [
                    Expanded(
                      child: FlutterFlowChoiceChips(
                        ...
                        onChanged: (val) async {
                          safeSetState(() =>
                              _model.swimGroupSelectorValue = val?.firstOrNull);
                          _model.activeGroup = _model.swimGroupSelectorValue!;
                          safeSetState(() {});
                        },
                        ...
                        rowSpacing: 8.0,
                        multiselect: false,
                        initialized: _model.swimGroupSelectorValue != null,
                        alignment: WrapAlignment.start,
                        controller: _model.swimGroupSelectorValueController ??=
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Current Active Group: ${_model.activeGroup}',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.sora(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 4.0, 0.0, 0.0),
                                child: Text(
                                  listViewActivitiesRecord.groupId,
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        font: GoogleFonts.sora(
