...
import 'demo_activity_editor_model.dart';
export 'demo_activity_editor_model.dart';
...
class DemoActivityEditorWidget extends StatefulWidget {
  const DemoActivityEditorWidget({super.key});

  @override
  State<DemoActivityEditorWidget> createState() =>
      _DemoActivityEditorWidgetState();
}

class _DemoActivityEditorWidgetState extends State<DemoActivityEditorWidget> {
  late DemoActivityEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DemoActivityEditorModel());
