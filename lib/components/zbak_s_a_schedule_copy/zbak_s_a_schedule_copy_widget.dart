...
import 'zbak_s_a_schedule_copy_model.dart';
export 'zbak_s_a_schedule_copy_model.dart';

class ZbakSAScheduleCopyWidget extends StatefulWidget {
  const ZbakSAScheduleCopyWidget({super.key});

  @override
  State<ZbakSAScheduleCopyWidget> createState() =>
      _ZbakSAScheduleCopyWidgetState();
}

class _ZbakSAScheduleCopyWidgetState extends State<ZbakSAScheduleCopyWidget>
    with TickerProviderStateMixin {
  late ZbakSAScheduleCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZbakSAScheduleCopyModel());
    ...
    animationsMap.addAll({
      ...
      'm01ActivityCardOnPageLoadAnimation1': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          FadeEffect(
            curve: Curves.easeInOut,
      ...
      'm01ActivityCardOnPageLoadAnimation2': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
                                    ...
                                    children: [
                                      M01ActivityCardWidget(
                                        ...
                                        activityItem: activitiesItem,
                                          ...
                                          'm01ActivityCardOnPageLoadAnimation1']!),
                                      M01ActivityCardWidget(
                                        key: Key(
                                        ...
                                        activityItem: activitiesItem,
                                          ...
                                          'm01ActivityCardOnPageLoadAnimation2']!),
                                    ],
                                  ),
                                ),
                              ).animateOnPageLoad(animationsMap[
