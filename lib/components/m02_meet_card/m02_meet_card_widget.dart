...
import 'm02_meet_card_model.dart';
export 'm02_meet_card_model.dart';

class M02MeetCardWidget extends StatefulWidget {
  const M02MeetCardWidget({
    super.key,
    this.title,
    this.subtitle,
    this.description,
  ...
  @override
  State<M02MeetCardWidget> createState() => _M02MeetCardWidgetState();
}

class _M02MeetCardWidgetState extends State<M02MeetCardWidget>
    with TickerProviderStateMixin {
  late M02MeetCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => M02MeetCardModel());
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (widget!.meetDoc?.isApproved == true)
                  Container(
                    decoration: BoxDecoration(
