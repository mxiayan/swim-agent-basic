...
import 'm05_activity_dashboard_model.dart';
export 'm05_activity_dashboard_model.dart';

class M05ActivityDashboardWidget extends StatefulWidget {
  const M05ActivityDashboardWidget({super.key});

  @override
  State<M05ActivityDashboardWidget> createState() =>
      _M05ActivityDashboardWidgetState();
}

class _M05ActivityDashboardWidgetState
    extends State<M05ActivityDashboardWidget> {
  late M05ActivityDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => M05ActivityDashboardModel());
                      ...
                      await showModalBottomSheet(
                        ...
                        builder: (context) {
                          return Padding(
                            ...
                            child: M05ActivityDashboardNewActivityCreatorWidget(
